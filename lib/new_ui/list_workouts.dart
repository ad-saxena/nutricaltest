...
class _ListYourWorkoutsState extends State<ListYourWorkouts> {
  ...
  Data date=new Data();
  String bodyParts="";
  String nameOfWorkout="hell";
  String equipment="";
  @override
  Widget build(BuildContext context) {
   // Data date=Provider.of<Data>(context);
                                        ...
                                        children: <Widget>[
                                          ...
                                          GestureDetector(
                                            ...
                                            onTap: () {
                                             ...
                                             // }
                                              //else {
                                                /*_data['nameOfWorkouts']=
                                                    snapshot.data['Items']
                                                        [index]['Name']['S'];
                                                print(_data['nameOfWorkouts']);
                                               _data['bodyParts'] = snapshot
                                                        .data['Items'][index]
                                                    ['Body_part']['S'];
                                                _data['equipment'] = snapshot
                                                        .data['Items'][index]
                                                    ['Equipment']['S'];*/
                                                date.name="hlo";
                                                //date.nameOfWorkout="hello world";
                                                print(snapshot.data['Items'][index]['Name']['S']);
                                                print(date.getName);
                                                //date.bodyParts=snapshot.data['Items'][index]['Body_part']['S'];
                                                //date..equipment=snapshot.data['Items'][index]['Equipment']['S'];
                                                //Data(snapshot.data['Items'][index]['Name']['S'],
                                                  //  snapshot.data['Items'][index]['Body_part']['S'],
                                                   // snapshot.data['Items'][index]['Equipment']['S']
                                                //);
                                                _controller.show();
                                             // }
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      date.nameOfWorkout==null?"null":"no",
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 22.0,
                        fontWeight: FontWeight.w600,
              ...
              RaisedButton(
                ...
                child: Text('Start Timer',style: TextStyle(
                  fontFamily: 'Varela',
                  color: Colors.white,
                  fontSize: 16.0,
                ),),
...
class Data{
  //Data(this.nameOfWorkout,this.bodyParts,this.equipment);
  String bodyParts;
